...
data = pd.read_csv('2_DATEN_CSVS/08_speakingTime_parteien_weighed_noFeuz')
...
fig.write_html("3_HTML/8_speakingTime_parteien_weighed_ohneFeuz.html", full_html=False, include_plotlyjs='cdn')
fig.show()
