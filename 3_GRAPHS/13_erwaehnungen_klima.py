...
fig = px.bar(
    ...
    x='doc_id',
    y='klima',
    labels={'doc_id': 'Partei', 'klima': 'Erwähnungen'},
    color_discrete_sequence=['#b3d6d8'],  # Bar color
    category_orders={'doc_id': df.sort_values('klima', ascending=False)['doc_id'].tolist()}
)
...
fig.write_html("3_HTML/13_erwaehnungen_klima.html", full_html=False, include_plotlyjs='cdn')
