...
df = pd.read_csv('2_DATEN_CSVS/01_top10_speakingTime')
...
fig = px.bar(
    ...
    y='redezeit',
    x='name',
    labels={'name': 'Politiker*in', 'redezeit': 'Redezeit in Minuten'},
...
fig.write_html("3_HTML/1_top_10_redezeit.html", full_html=False, include_plotlyjs='cdn')
